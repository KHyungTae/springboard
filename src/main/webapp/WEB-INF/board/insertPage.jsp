	...
	<form id="boardForm">
		...
		<table class="table">
			...
			<tr>
				...
				<td>
					<input type="file" id="files" name="files" size="120%"/>
				</td>
			</tr>
			<tr>
				<th width="15%">작성자</th>
	...
	function setPageInsert() {
		...
		$("#boardForm").submit(function(event) {
			...
			if(validate()) {
				...
				formData.contents = $("textarea[name=contents]").val();
				formData.regt_nm = $("input[name=regt_nm]").val();
				formData.regt_id = $("input[name=regt_id]").val();
